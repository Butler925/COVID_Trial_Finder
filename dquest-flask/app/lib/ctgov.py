...
def get_nct_list_from_zip(input_zip):
    zcdb = ZipCodeDatabase()
    zip_list = [z.zip for z in zcdb.get_zipcodes_around_radius(input_zip, 100)]  # default mile range set at 100
    ...
    for item in trial_zips:
        ...
        if test_zip in zip_list:
            nearby_nct_list.append(test_nct)
