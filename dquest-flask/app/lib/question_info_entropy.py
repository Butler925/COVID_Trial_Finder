...
def filter_nct_ids_by_pre_questions(answer_list):
    ...
    cur = conn.cursor()
    params = [age, age, domain, domain, domain, domain, exposure, exposure, exposure, stat, stat,
    ...
    sql = '''
            ...
            from dbo.aact_trial_info as aact
...
def find_active_nct_id_list():
    ...
    sql = '''
        ...
        from dbo.aact_trial_info as aact
        where status in ('Recruiting', 'Enrolling by invitation', 'Available') and nct_id in ( select distinct(nct_id)
...
def find_new_question(question_answer_list, working_nct_id_list, domain='all'):
    ...
    working_nct_id_0 = [str(record[0]) for record in working_nct_id_list if record[2] == 0]

    working_nct_id_0_len = len(working_nct_id_0)
    placeholders1 = ",".join(str("'" + x + "'") for x in working_nct_id_0)
    print('working_list: ' + str(working_nct_id_list))
    print('Placeholders 1: ' + str(placeholders1))
    ########################################################################################################################
...
def update_working_nct_id_list(question_answer_list, working_nct_id_list):
    ...
    if question_number > 0:
        ...
        for nct_record in working_nct_id_list:
            if nct_record[0] in filtered_nct_id:
